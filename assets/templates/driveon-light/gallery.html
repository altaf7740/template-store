					...
					<div class="main-menu mean-menu float-right">
						<nav>
							<ul>
								...
								<li><a href="#">features<i class="icofont icofont-simple-down"></i></a>
									<ul>
								...
								<li><a href="#">shortcode<i class="icofont icofont-simple-down"></i></a>
									<ul>
										...
										<li><a href="shortcode-toggles-accordions.html">Toggles Accordions</a></li>
									</ul>
								</li>
								<li class="active"><a href="gallery.html">gallery<i class="icofont icofont-simple-down"></i></a>
									<ul>
										<li><a href="gallery-2-column.html">Gallary 2 Column</a></li>
										<li><a href="gallery-3-column.html">Gallary 3 Column</a></li>
										<li><a href="gallery.html">Gallary 4 Column</a></li>
									</ul>
								</li>
...
<div id="gallery-area" class="gallery-area bg-gray pt-90 pb-90">
	<div class="container">
		...
		<div class="gallery-grid row mb-20">
			...
			<div class="gallery-item cars students exam col-md-3 col-sm-4 col-xs-12">
			...
			<div class="gallery-item students classroom col-md-3 col-sm-4 col-xs-12">
