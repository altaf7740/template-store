                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="b-header-text">
                            <h1>ABOUT <span>Galleria</span></h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-lg-12">
                        ...
                        <div class="purchase-text">
                            ...
                            <h2>FREEDOM OF SHOPPING</h2>
                            <a href="#" class="purchase-btn">Shop now</a>
                        </div>
                        <div class="our-views">
                            <h3>Our Views</h3>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <p class="number">01</p>
                                    <h4>OUR MISSION</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor               incididunt ut labore et dolore magna aliqua. U t enim ad minim veniam, quis norud itation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <p class="number">02</p>
                                    <h4>OUR VISSION</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                        <div class="single-team-item">
                            <a href="#"><img src="img/team/team-1.jpg" alt="member"></a>
                            <div class="team-hover">
                                <a href="#"><i class="fa fa-plus"></i></a>
                                <div class="team-links">
                                    <a class="portfolio-facebook" href="#"><i class="fa fa-facebook"></i></a>
                                    <a class="portfolio-twitter" href="#"><i class="fa fa-twitter"></i></a>
                                    <a class="portfolio-linkedin" href="#"><i class="fa fa-linkedin"></i></a>
                                    <a class="portfolio-google-plus" href="#"><i class="fa fa-google-plus"></i></a>        
                                </div>
                            </div>
                        </div>
                        <div class="team-text">
                            <h2><a href="#">Nawaz Sharif</a></h2>
                            <h3>CEO &amp; HEAD OF COMPANY</h3>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                        <div class="single-team-item">
                            <a href="#"><img src="img/team/team-2.jpg" alt="member"></a>
                            <div class="team-hover">
                                <a href="#"><i class="fa fa-plus"></i></a>
                                <div class="team-links">
                                    <a class="portfolio-facebook" href="#"><i class="fa fa-facebook"></i></a>
                        ...
                        <div class="team-text">
                            <h2><a href="#">Thoms Albert</a></h2>
                            <h3>HEAD OF IDEAS</h3>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                        <div class="single-team-item">
                            <img src="img/team/team-3.jpg" alt="member">
                            <div class="team-hover">
                                <a href="#"><i class="fa fa-plus"></i></a>
                                <div class="team-links">
                                    <a class="portfolio-facebook" href="#"><i class="fa fa-facebook"></i></a>
                        ...
                        <div class="team-text">
                            <h2><a href="#">Zakulin Farnandez</a></h2>
                            <h3>HEAD OF DESIGN</h3>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 hidden-sm col-xs-12">
                        <div class="single-team-item">
                            <img src="img/team/team-4.jpg" alt="member">
                            <div class="team-hover">
                                <a href="#"><i class="fa fa-plus"></i></a>
                                <div class="team-links">
                                    <a class="portfolio-facebook" href="#"><i class="fa fa-facebook"></i></a>
