...
<html lang="en">
    <head>
        ...
        <!---Title-->
        <title>Galleria - Product Details</title>
        <!--Google Fonts-->
    ...
    <body class="blog-main shop-main">
                            ...
                            <div class="header-top-right-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="img/flag.png" alt="">English<i class="fa fa-angle-down"></i></a>
            ...
            <div class="header-main-area">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="logo">
                                <a href="#"><img src="img/logo.png" alt="Galleria"></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="register">
                                <ul>
                                    <li><a href="#"><i class="fa fa-share-square-o"></i>Login</a></li>
                                    <li><a href="#"><i class="fa fa-lock"></i>Register</a></li>
                                </ul>
                                <ul class="header-main-right"> 
                                    <li><a href="#" class="cart"><i class="fa fa-shopping-cart"></i><span>2</span></a>
                                ...
                                <ul id="nav">
                                    <li class="current"><a href="index.html">HOME</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="index-two.html">Homepage Version 2</a></li>
                                            <li><a href="index-three.html">Homepage Version 3</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a href="#">MENS</a>
                                        <div class="megamenu">
											<span>
												<a href="#" class="mega-title">Outfits</a>
												<a href="#">T-Shirts</a>
												<a href="#">Jackets</a>
												<a href="#">BlaZers</a>
												<a href="#">Shirts</a>
											...
											<span>											
												<a href="#" class="mega-title">Accssesories</a>
												<a href="#">Wrist Watch</a>
												<a href="#">Sunglass</a>
												<a href="#">Exclusive Cap</a>
												<a href="#">Perfumes</a>
											</span>
											<span>											
												<a href="#" class="mega-title">Exclusive</a>
												<a href="#">Branded Pants </a>
												<a href="#">Branded Shoes</a>
												<a href="#">Exclusive Jeans</a>
												<a href="#">Winter Keds</a>
											</span>
										</div>
                                    </li>
                                    <li><a href="#">WOMENS</a>
                                    ...
                                    <li class="right-megamenu"><a href="#">PAGES</a>
                                        <div class="megamenu">
											<span>
												<a href="shop.html">Shop</a>					
												<a href="product-details.html">Shop Fullwidth</a>					
											...
											<span>
												...
												<a href="comming-soon.html">Commingsoon</a>						
        ...
        <section class="blog-header-area prdoduct-details">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="container">
                <div class="row">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="active">
                                        <a href="#img-1" data-toggle="tab">
                                            <img alt="" src="img/product/tab-s-1.jpg">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#img-2" data-toggle="tab">
                                            <img alt="" src="img/product/tab-s-2.jpg">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#img-3" data-toggle="tab">
                                            <img alt="" src="img/product/tab-s-3.jpg">
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7">
                        ...
                        <div class="p-d-cart">
                            <a href="#" class="p-d-btn">ADD TO CART</a>
                        ...
                        <div class="p-details-tab">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="description">
                                    <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiatLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut  Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est.</p>
                                ...
                                <div role="tabpanel" class="tab-pane" id="tags">
                                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut    labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat. </p>
                                    <p> Ut enim ad minim veniam, quis nostrud quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="single-product-items">
                        <div class="single-items">
                            <a href="product-details.html">
                                <img class="primary-img" src="img/product/product-5.jpg" alt="">
                                <img class="secondary-img" src="img/product/product-25.jpg" alt="">
                    ...
                    <div class="single-product-items">  
                        <div class="single-items">
                            <a href="product-details.html">
                                <img class="primary-img" src="img/product/product-6.jpg" alt="">
                                <img class="secondary-img" src="img/product/product-16.jpg" alt="">
                            </a>
                            <div class="product-hover">
                                <div class="product-links">
                                    <a href="#"><i class="fa fa-search"></i></a>
                    ...
                    <div class="single-product-items">  
                        <div class="single-items">
                            <a href="product-details.html">
                                <img class="primary-img" src="img/product/product-7.jpg" alt="">
                                <img class="secondary-img" src="img/product/product-20.jpg" alt="">
                            </a>
                            <div class="product-hover">
                                <div class="product-links">
                                    <a href="#"><i class="fa fa-search"></i></a>
                    ...
                    <div class="single-product-items">
                        <div class="single-items">
                            <a href="product-details.html">
                                <img class="primary-img" src="img/product/product-8.jpg" alt="">
                                <img class="secondary-img" src="img/product/product-19.jpg" alt="">
                                <span class="image-text-bg"></span>
                                <span class="image-text">HOT</span>
                            </a>
                            <div class="product-hover">
                                <div class="product-links">
                                    <a href="#"><i class="fa fa-search"></i></a>
                    ...
                    <div class="single-product-items">  
                        <div class="single-items">
                            <a href="product-details.html">
                                <img class="primary-img" src="img/product/product-9.jpg" alt="">
                                <img class="secondary-img" src="img/product/product-23.jpg" alt="">
                            </a>
                            <div class="product-hover">
                                <div class="product-links">
                                    <a href="#"><i class="fa fa-search"></i></a>
        ...
        <!--Brand Area Start-->
        <div class="home-three-brand-area">
            <div class="container">
                <div class="row">
                    <div class="brand-home-three">
                        ...
                        <div class="col-md-4">
                            <div class="single-brand">
                                <a href="#"><img src="img/brand/brand-6.png" alt=""></a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="single-brand">
                                <a href="#"><img src="img/brand/brand-7.png" alt=""></a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="single-brand">
                                <a href="#"><img src="img/brand/brand-8.png" alt=""></a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="single-brand">
                                <a href="#"><img src="img/brand/brand-9.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="footer-widget">
                            <div class="single-footer right">
                                ...
                                <ul class="s-f-widget">
                                    ...
                                    <li>Saturday<span>9.00 - 21.00</span></li>
                                    <li>Sunday<span>10.00 - 21.00</span></li>
                                </ul>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5 col-sm-5">
                        <div class="footer-left">
                            <p>Copyright &copy; 2015<a href="#">BootExpert</a>. All rights reserved.</p>
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-7 col-sm-7">
